public class Main {
    public static void main(String[] args) {
        ...
        String catfood = "Кот";
        if (petType.toLowerCase().indexOf(dogfood.toLowerCase()) != -1) {
            System.out.println("Подходящий корм - сухой корм, говядина, мясо практически любой птицы\nНеподходящий корм - рыба, авокадо, лук");
        }
        if (petType.toLowerCase().indexOf(catfood.toLowerCase()) != -1) {
            System.out.println("Подходящий корм - сухой корм, злаки, курица\nНеподходящий корм - орехи, томаты, виноград");
        }
    }
}
